...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  sql: {
    ...
    label: "SQL",
    logoPath: "/sql.png",
    pistonRuntime: { language: "sql", version: "3.36.0" }, // SQLite version
    monacoLanguage: "sqlite3",
...
SELECT SUM(value) AS total_sum FROM numbers;
...
main = do
  ...
  putStrLn $ "Sum of numbers: " ++ show sumNumbers`,
  },
};
